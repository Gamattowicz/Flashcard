...
from .views import ExerciseList, ExerciseAllList, ExerciseDetail, ExerciseCreate, ExerciseUpdateCorrectAnswer, \
    ExerciseUpdateWrongAnswer, ExerciseUpdateTime
...
urlpatterns = [
    ...
    path('<str:pk>/time/', ExerciseUpdateTime.as_view(), name='update_time'),
